...
import "github.com/RuneHistory/collector/internal/application/domain/bucket"
...
type BucketValidator interface {
	...
	NewBucket(b *bucket.Bucket) error
}
...
func (v *StdBucketValidator) NewBucket(b *bucket.Bucket) error {
